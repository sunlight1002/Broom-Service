...
Route::group(['middleware' => ['auth:admin-api', 'scopes:admin', 'log.admin.activity']], function () {
    ...
    Route::get('jobs/get-shift-client/{id}/{date}', [JobController::class, 'getJobShiftClient']);
    Route::post('jobs/{id}/change-client-shift/{job_id}', [JobController::class, 'changeShift']);
    ...
    Route::post('jobs/complete-by-supervisor', [JobController::class, 'handleSupervisorJobStatus']);
