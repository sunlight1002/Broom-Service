...
return [
    ...
    'insuarance_company' => [
        'subject' => 'Insurance Policy Creation for Foreign Worker – :worker_name',
        'header' => 'Hello,',
        'body' => "Please find attached the insurance policy document for the foreign worker :worker_name. Please create an insurance policy for them according to the required conditions.📅 Work start date: :work_start_date",
        'confirmation' => "Please confirm receipt of the request and update with policy details as soon as possible.",
        'company' => 'Broom Service Team',
    ],
    'stop_insuarance_form_non_israel' => [
        'subject' => 'Stop Insurance Policy for Foreign Worker – :worker_name',
        'header' => 'Hello,',
        'body' => "Please stop the insurance policy for the foreign worker :worker_name, as they have finished their work with us.📅 Work end date: :work_end_date",
        'confirmation' => "Please confirm the termination and update us accordingly.",
        'company' => 'Broom Service Team',
    ],
    'stop_insuarance_form_israel' => [
        'subject' => 'Stop Insurance Policy for Israeli Worker – :worker_name',
        'header' => 'Hello,',
        'body' => "Please stop the insurance policy for the Israeli worker :worker_name, as they have finished their work with us.📅 Work end date: :work_end_date",
        'confirmation' => "Please confirm the termination and update us accordingly.",
        'company' => 'Broom Service Team',
    ],
    'insuarance_company_israel' => [
        'subject' => 'Insurance Policy Creation for Israeli Worker – :worker_name',
        'header' => 'Hello,',
        'body' => "Please find attached the insurance policy document for the Israeli worker :worker_name. Please create an insurance policy for them according to the required conditions.📅 Work start date: :work_start_date",
        'confirmation' => "Please confirm receipt of the request and update with policy details as soon as possible.",
        'company' => 'Broom Service Team',
    ],
    'worker_credentials' => [
