                                ...
                                taskComments.map((com) => (
                                    <div key={com.id} className="comment-item d-flex align-items-start mb-3">
                                        <div className="comment-author-icon mr-3">
                                            <div className="circle-icon d-flex align-items-center ml-1 justify-content-center" style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: '#007bff', color: '#fff', fontSize: '18px' }}>
                                        ...
                                        <div className="comment-content w-100">
                                            <div className='mb-1' style={{ border: "1px solid #DDDDDD", padding: "10px" }}>
                                                ...
                                                {editingCommentId === com.id && isEditable ? (
                                                    ...
                                                    <div className="comment-text pt-0 px-2 py-1 mt-2">
                                                        {com.comment}
                                                    </div>
                                                )}
                                            </div>
                                            <div className="comment-actions d-flex justify-content-end">
                                                {editingCommentId === com.id ? (
                                                    <button className="btn btn-link p-0 mr-3" onClick={() => handleUpdateComment(com.id)}>
                                                        Update
                                                    </button>
                                                ) : (
                                                    <button className="btn btn-link p-0 mr-3" onClick={() => {
                                                ...
                                                <button className="btn btn-link p-0 text-danger" onClick={() => handleDeleteComment(com.id)}>
                                                    Delete
                                                </button>
                                            </div>
                                        </div>
