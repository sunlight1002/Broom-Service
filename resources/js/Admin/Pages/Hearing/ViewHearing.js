...
function ViewHearing() {
                ...
                .then((res) => {
                    ...
                    if (res.data.errors) {
                        ...
                        if (response.data.action === "redirect") {
                            // navigate("/admin/workers-hearing");
                        }
                    }
                })
                .catch((e) => {
    ...
    const getWorker = () => {
        axios
            .get(`/api/admin/workers/${workerId}`, { headers })
            .then((res) => {
    ...
    const getSchedule = () => {
        setIsLoading(true);
        const response = axios.get(`/api/admin/scheduled-hearings/${hid}`, { headers })
        .then((res) => {
                setIsLoading(false);
                const d = res.data;
                setSchedule(d);
                            ...
                            <div className="form-group">
                                ...
                                >
                                    <option value="pending">
                                        {t(
                                            "admin.hearing.options.hearingStatus.Pending"
                                        )}
                                    </option>
                                    <option value="confirmed">
                                        {t(
                                            "admin.hearing.options.hearingStatus.Confirmed"
                                        )}
                                    </option>
                                    <option value="declined">
                                        {t(
                                            "admin.hearing.options.hearingStatus.Declined"
                                        )}
                                    </option>
                                    <option value="completed">
                                        {t(
                                            "admin.hearing.options.hearingStatus.Completed"
                                        )}
                                    </option>
                                    <option value="rescheduled">
                                        {t(
                                            "admin.hearing.options.hearingStatus.rescheduled"
                                        )}
                                    </option>
                                </select>
                            </div>
                        ...
                        <div className="col-sm-6">
                            <div className="form-group">
                                ...
                                >
                                    <option value="">
                                        {t(
                                            "admin.hearing.options.pleaseSelect"
                                        )}
                                    </option>
                                    {totalTeam &&
                                        totalTeam.map((t, i) => {
                            ...
                            <div className="form-group">
                                ...
                                >
                                    <option value="on-site">
                                        {t(
                                            "admin.hearing.options.meetVia.onSite"
                                        )}
                                    </option>
                                    <option value="off-site">
                                        {t(
                                            "admin.hearing.options.meetVia.offSite"
                                        )}
                                    </option>
                                </select>
                            </div>
