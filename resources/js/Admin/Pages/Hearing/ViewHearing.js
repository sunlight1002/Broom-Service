...
//         axios
//         .get(`/api/admin/scheduled-hearings/${sid}`, { headers })
//         .then((res) => {
//                 setIsLoading(false);
...
//     //     setIsLoading(true);
//     //     try {
//     //         // Use sid from query params in your API call
//     //         const response = await axios.get(`/api/admin/scheduled-hearings/${sid}`, { headers });
//     //         const data = response.data; // Directly use response.data since the required data is at the root level
    
//     //         // Update state with the fetched data
//     //         setSchedule(data); // Save the full data if needed
//     //         setTeamId(data.team_id ? data.team_id.toString() : "");
//     //         setStartDate(data.start_date ? Moment(data.start_date).toDate() : null);
//     //         setStartTime(data.start_time || "");
//     //         setMeetVia(data.meet_via);
//     //         setMeetLink(data.meet_link ?? "");
//     //         setPurpose(data.purpose);
//     //         setBookingStatus(data.booking_status);
//     //         setAddressId(data.address_id);
//     //     } catch (error) {
//     //         alert.error("Failed to fetch schedule");
//     //     } finally {
//     //         setIsLoading(false);
//     //     }
//     // };
