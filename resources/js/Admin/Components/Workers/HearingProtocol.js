                        ...
                        <div className="col-sm-6">
                            <div className="form-group">
                                {messages.map((msg, index) => (
                                    <div key={index} className={`flex ${msg.type === 'admin' ? 'justify-start' : 'justify-end'}`}>
                                        <div className={`p-3 rounded-lg max-w-xs ${msg.type === 'admin' ? 'bg-blue-100 text-left' : 'bg-green-100 text-right'}`}>
                                            {msg.type === 'admin' ? (
