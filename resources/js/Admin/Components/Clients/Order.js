...
export default function Order() {
    ...
    const handlePageClick = async (data) => {
        ...
        axios
            .get(
                `/api/admin/client-orders/${id}?page=` +
                    currentPage +
                    "&" +
                    filtered,
                { headers }
            ...
            <div className="action-dropdown dropdown order_drop text-right mb-3">
                ...
                <div className="dropdown-menu">
                    ...
                    <button
                        className="dropdown-item"
                        onClick={(e) => {
                            setFiltered("invoice_status=m");
                            getOrders("invoice_status=m");
                        }}
                    >
                        Invoiced - {res.generated}
                    </button>
                    <button
                        className="dropdown-item"
                        onClick={(e) => {
                            setFiltered("invoice_status=0");
                            getOrders("invoice_status=0");
                        }}
                    >
                        Not Invoiced - {res.not_generated}{" "}
                    </button>
                </div>
            </div>
