                    ...
                    <div className="maxWidthControl dashBox mb-4">
                        ...
                        <div className="we-have">
                            ...
                            <div className="shift-20">
                                <h4>
                                    1. Room Service On A Regular Basis
                                    Customized To Your Requirements:
                                </h4>
                                <ul className="list-unstyled">
                                    <li>
                                        <img src={star} /> Service on a regular
                                        basis by the same professional staff
                                    </li>
                                    <li>
                                        <img src={star} /> Employing a legal and
                                        regulated employee
                                    </li>
                                    <li>
                                        <img src={star} /> Strict sorting of
                                        staff including reliability tests
                                    </li>
                                    <li>
                                        <img src={star} /> Use of advanced
                                        cleaning materials and equipment at our
                                        expense
                                    </li>
                                    <li>
                                        <img src={star} /> Tight supervision by
                                        a regional supervisor
                                    </li>
                                </ul>
                                <h4 className="mt-4">
                                    2. Our packages- Other Services
                                </h4>
                                <p>
                                    This is a test line and it will be changed
                                    according to the other service
                                </p>
                                <h4 className="mt-4">
                                    3. Cleaning Inside And Outside Windows At
                                    Any Height:
                                </h4>
                                <ul className="list-unstyled">
                                    <li>
                                ...
                                <h4 className="mt-4">
                                    4. Laundry Services, Fabric Cleaning And
                                    Upholstery:
                                </h4>
                                <ul className="list-unstyled">
                                    <li>
