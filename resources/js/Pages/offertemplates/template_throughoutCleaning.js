                ...
                <div className="send-offer">
                    <div className="maxWidthControl dashBox mb-4">
                        ...
                        <div className="abt">
                            <h2>About us</h2>
                            <p>
                                Broom Service was founder by Lidor Mamou on 2013
                                The company employs a team of professionals in a
                                wide variety of house cleaning and maintenance
                                jobs. Our staff are regular and experienced
                                employees Our staff are regular and experienced
                                employees who receive a fair and proper reward
                                and all the beneﬁts they receive according to
                                the law Our clients are accustomed and well
                                acquainted with the high standard of service
                                used in the best luxury and boutique hotels in
                                Israel and worldwide and we strive to meet this
                                high quality standard. Our customer
                                satisfaction, high level of service, attention
                                to detail and personal attitude are the
                                foundations on which we base our services. The
                                company is registered as a legal cleaning
                                company in the Ministry of Industry. License
                                number: 4569{" "}
                            </p>
                        </div>
                        <div className="we-have">
                            ...
                            <div className="shift-20">
                                ...
                                <ul className="list-unstyled">
                                    <li>
                                        <img src={star} /> Thorough dust.
                                    </li>
                                    <li>
                                        <img src={star} /> Vacuuming carpets and
                                        sofas.
                                    </li>
                                    <li>
                                        <img src={star} /> Interior and exterior
                                        windows including shutters, rails and
                                        frames.
                                    </li>
                                    <li>
                                        <img src={star} /> Toilets / showers –
                                        cleaning and disinfection.
                                    </li>
                                    <li>
                                        <img src={star} /> Tasks: vents, air
                                        conditioners, lamps, chandeliers and
                                        celling fans. Electrical switches,
                                        panels, doors, handles and lintels.
                                    </li>
                                    <li>
                                        <img src={star} /> Bes linen change /
                                        bedding.
                                    </li>
                                    <li>
                                        <img src={star} /> Replacing bags and
                                        cleaning bins.
                                    </li>
                                    <li>
                                        <img src={star} /> Kitchen: kitchen
                                        cabinets, thorough cleaning of the
                                        refrigerator, microwave, oven and gas,
                                        dishwasher and sink.{" "}
                                    </li>
                                    <li>
                                        <img src={star} /> Thorough washing of
                                        the floor and perfume of the apartment.{" "}
                                    </li>
                                    <li>
                                        <img src={star} /> Thorough arrangement
                                        and cleaning: kitchen and pantry
                                        cabinets, wardrobes, general cabinets
                                        and drawers in the house, warehouse.
                                    </li>
                                    <li>
                                        <img src={star} /> Including cleaning
                                        meterials + foreman.{" "}
                                    </li>
                                </ul>
                                <h4 className="mt-4">
                                    2. Standard package which includes:
                                </h4>
                                <ul className="list-unstyled">
                                    <li>
                                        <img src={star} /> Thorough dust.
                                    ...
                                    <li>
                                        <img src={star} /> Tasks: vents, air
                                        conditioners, lamps, electrical
                                        switches, panels, doors, handles and
                                        lintels.
                                    </li>
                                    <li>
                                        <img src={star} /> Bes linen change /
                                    ...
                                    <li>
                                        <img src={star} /> Kitchen: kitchen
                                        cabinets (outside), thorough cleaning of
                                        the refrigerator, microwave, oven and
                                        gas, dishwasher and sink.
                                    </li>
                                    <li>
                                        <img src={star} /> Thorough washing of
                                        the floor and perfume of the apartment.{" "}
                                ...
                                <h4 className="mt-4">
                                    3. Basic package which includes:
                                </h4>
                                <ul className="list-unstyled">
                                    <li>
                                        <img src={star} /> Thorough dust.
                                    ...
                                    <li>
                                        <img src={star} /> Kitchen: kitchen
                                        cabinets (outside), microwave, oven and
                                        gas, dishwasher and sink.{" "}
                                    </li>
                                    <li>
                                        <img src={star} /> Thorough washing of
                                ...
                                <h4 className="mt-4">
                                    4. Cleaning Inside And Outside Windows At
                                    Any Height:
                                </h4>
                                <ul className="list-unstyled">
                                    <li>
                                        <img src={star} /> Professional cleaning
                                        of windows, blinds, rails, frames on a
                                        regular basis or on demand.
                                    </li>
                                    <li>
                                        <img src={star} /> Cleaning all types of
                                        windows at all heights.{" "}
                                    </li>
                                    <li>
                                        <img src={star} /> Nano coating option
                                        after cleaning the windows for clean
                                        windows over time.
                                    </li>
                                    <li>
                                        <img src={star} /> Cleaning in
                                        rappelling by a professional team.
                                    </li>
                                </ul>
                                <h4 className="mt-4">
                                    5. Laundry Services, Fabric Cleaning And
                                    Upholstery:
                                </h4>
                                <ul className="list-unstyled">
                                    <li>
                                        <img src={star} /> Pick up on order day
                                        and return up to 48 hours
                                    </li>
                                    <li>
                                        <img src={star} /> Laundry services{" "}
                                    </li>
                                    <li>
                                        <img src={star} /> Dry Cleaning
                                    </li>
                                    <li>
                                        <img src={star} /> Ironing services
                                    </li>
                                    <li>
                                        <img src={star} /> Cleaning of sofas,
                            ...
                            <div className="shift-20">
                                ...
                                <ul className="list-unstyled">
                                    ...
                                    <li>
                                        ...
                                        various levels, customized to you and
                                        your needs.{" "}
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <img src={star} /> The most advanced
                                        equipment at our expense - without acids
                                        and dangerous{" "}
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <img src={star} /> Final payment at the
                                        end of the work by credit card.
                                    </li>
                                </ul>
                                <h4 className="mt-4">
