...
const data = {};
export default function Form101_old() {
    ...
    const handleSubmit = (e) => {
        ...
        if (e.target.name == "breakIncome") {
            const ikr = {};
            let bincm = document.querySelectorAll(
                'input[name="breakIncome"]:checked'
            );
            bincm.forEach((e, i) => {
                i == 0
            ...
            const ik = {};
            let incm = document.querySelectorAll(
            ...
            const exr = {};
            let exa = document.querySelectorAll(
                'input[name="excertion"]:checked'
            );
            exa.forEach((e, i) => {
                i == 0
            ...
            const txc = {};
            let tx = document.querySelectorAll(
                'input[name="taxCredit"]:checked'
            );
            tx.forEach((e, i) => {
                i == 0
        ...
        data["bid-sex"] = document.querySelector(
            'input[name="bid-sex"]:checked'
        ).value;
        data["p-sex"] = document.querySelector(
            'input[name="p-sex"]:checked'
        ).value;
        data["moreIncome"] = exIncome;
        if (exIncome == true) {
            let cp = document.querySelector(
                'input[name="creditPoints"]:checked'
            ).value;
    ...
    const finalSubmit = () => {
        ...
        data["cord"] = cord;
        data["bid-martial"] = document.querySelector(
            'input[name="bid-martial"]:checked'
        ).value;
        data["bid-israeli"] = document.querySelector(
            'input[name="bid-israeli"]:checked'
        ).value;
        data["bid-member"] = document.querySelector(
            'input[name="bid-member"]:checked'
        ).value;
        data["bid-hmo"] = document.querySelector(
            'input[name="bid-hmo"]:checked'
        ).value;

        data["p-martial"] = document.querySelector(
            'input[name="p-martial"]:checked'
        ).value;
        data["p-hmo"] = document.querySelector(
            'input[name="p-hmo"]:checked'
        ).value;
        ...
        if (!Data.last_name) {
            alert.error("Please enter lastname");
            success = false;
            return false;
        }

        if (!Data.identification) {
            alert.error("Please choose identification");
            success = false;
            return false;
            ...
            if (formValues.length > 0) {
                for (let sv in formValues) {
                    if (formValues[sv].name == "") {
                        alert.error(
                            "One of the name in child details is missing"
                        );
                        success = false;
                        return false;
                    }
                    if (formValues[sv].idnum == "") {
                        alert.error(
                            "One of the Id number in child details is missing"
                        );
                        success = false;
                        return false;
                    }
                    if (formValues[sv].childDob == "") {
                        alert.error(
                            "One of date of birth in child details is missing"
                        );
                        success = false;
                        return false;
                    }
                    if (
                        formValues[sv].custody == "" &&
                        formValues[sv].childBenefit == ""
                    ) {
                        alert.error(
                            "One of the custody/child benifit selection is missing"
                        );
                        success = false;
                        return false;
                    }
        ...
        if (cordination == true && cord == null) {
            alert.error(
                "Please select the reason for the request in  cordination number"
            );
            success = false;
            return false;
        }
        if (cordination == true && cord == "1") {
            for (let sv in salValues) {
                let it = document.querySelector(
                    'input[name="typeIncome' + sv + '"]:checked'
                );
                salValues[sv].typeIncome = it != null ? it.value : "";

                if (salValues[sv].name == "") {
                    alert.error(
                        "One of the name in additional income is missing"
                    );
                    success = false;
                    return false;
                }
                ...
                if (salValues[sv].address == "") {
                    alert.error(
                        "One of the address in additional income is missing"
                    );
                    success = false;
                    return false;
                }
                ...
                if (salValues[sv].dfid == "") {
                    alert.error(
                        "One of the deduction ID in additional income is missing"
                    );
                    success = false;
                    return false;
                }
                if (salValues[sv].mIncome == "") {
                    alert.error(
                        "One of the monthly income in additional income is missing"
                    );
                    success = false;
                    return false;
                }
                if (salValues[sv].taxDeducted == "") {
                    alert.error(
                        "One of the tax deduction value in additional income is missing"
                    );
                    success = false;
                    return false;
                }
                ...
                if (
                    salValues[sv].typeIncome == "" ||
                    salValues[sv].typeIncome == null
                ) {
                    alert.error(
                        "One of the type of income in additional income is not selected"
                    );
                    success = false;
                    return false;
                }
        ...
        if (!Data.income) {
            alert.error("Please choose income details");
            success = false;
            return false;
        }
        if (!Data.taxDate) {
            alert.error("Please enter date of commencement ");
            success = false;
            return false;
        }
        if (!Data.signature || Data.signature == null) {
            alert.error("Please sign form");
            success = false;
            return false;
        }
        if (!Data.employerEmail) {
            alert.error("Please enter employer's email");
            success = false;
            return false;
        }
        if (!Data.employesEmail) {
            alert.error("Please enter employer's email");
            success = false;
            return false;
        }
        ...
        if (success == true) {
            axios.post(`/api/form101`, { id: id, data: Data }).then((res) => {
        ...
        axios.get(`/api/get101/${id}`).then((res) => {
            ...
            if (res.data.form.length > 0) {
                if (res.data.form[0].form_101 != null) {
                    ...
                    if (
                        fm.child_form != undefined &&
                        fm.child_form.length != 0 &&
                        fm.child_form != ""
                    ) {
                        setFormValues(fm.child_form);
                    }
                    if (
                        fm.salary_form != undefined &&
                        fm.salary_form.length != 0 &&
                        fm.salary_form != ""
                    ) {
    ...
    if(form && form.signature != null){
      ...
      if(form['salary_form'] != "" && form['salary_form'] != undefined && form['salary_form'].length != 0){
        form['salary_form'].map((s,i)=>{
          ...
          idpr.innerHTML = "<div className='m-2'><h3 style='text-align:center'>Copy of PaySlip " +(i+1)+"</h3><img src='"+s.copy_of_pay+"' style='width: -webkit-fill-available;'  className='m-4'></div>";
          console.log(idpr);
          insertAfter(r,idpr);
      ...
      if(form['cord'] != "" && form['cord'] == "0" && form['cord0_file'] != null){
        let idpr = document.createElement("div");
        idpr.innerHTML = "<div className='m-2'><h3 style='text-align:center'>Photocopy Of Income Lack Proof</h3><img src='"+form["cord0_file"]+"' style='width: -webkit-fill-available;'  className='m-4'></div>";
        insertAfter(r,idpr);
      ...
      if(form['cord'] != "" && form['cord'] == "0" && form['cord2_file'] != null){
        let idpr = document.createElement("div");
        idpr.innerHTML = "<div className='m-2'><h3 style='text-align:center'>Tax Coordination Approval</h3><img src='"+form["cord2_file"]+"' style='width: -webkit-fill-available;'  className='m-4'></div>";
        insertAfter(r,idpr);
      ...
      if(form['photocopy_id_appendix'] != "" && form['identification'] == "byId"){
        let idpr = document.createElement("div");
        idpr.innerHTML = "<div className='m-2'><h3 style='text-align:center'>Photocopy Of ID Proof</h3><img src='"+form["photocopy_id_appendix"]+"' style='width: -webkit-fill-available;' className='m-4'></div>";
        insertAfter(r,idpr);
      ...
      if(form['p-file'] != "" && form['identification'] == "passport"){
        let idpr = document.createElement("div");
        idpr.innerHTML = "<div className='m-2'><h3 style='text-align:center'>Photocopy Of Passport</h3><img src='"+form["p-file"]+"' style='width: -webkit-fill-available;'  className='m-4'></div>";
        insertAfter(r,idpr);
        ...
        <div className="container">
            <div className="form101 p-4">
                ...
                <div className="box-heading">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-3 col-xs-6">
                            <div className="form-group">
                                <label className="control-label">
                                    {t("form101.label_ddfileId")}
                                </label>
                                <input
                                    type="text"
                                    className="form-control man"
                                    onChange={(e) => handleSubmit(e)}
                                    name="deduction_fileId"
                                    placeholder="Deduction file ID"
                                />
                            </div>
                        </div>
                    </div>
                ...
                <div className="box-heading">
                    ...
                    <div className="row">
                                ...
                                form["identification"] != null ? (
                                    ...
                                    <>
                                        <input
                                            ...
                                            value="byId"
                                            id="byId"
                                            checked={selected === "byId"}
                                            onChange={(e) => {
                                                handleSubmit(e);
                                                setSelected(e.target.value);
                                            }}
                                        />
                                        <label className="mr-2" htmlFor="byId">
                                            {t("form101.label_id")}
                                        </label>
                        ...
                        <div className="col-sm-12">
                            <div
                                aria-hidden={selected !== "byId" ? true : false}
                            >
                                <div className="row">
                                    <div className="col-sm-4 col-xs-6">
                                        <div className="form-group">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <select className="form-control pid">
                                                ...
                                                <option value="Petah Tikva">
                                                    {t("form101.petah_tikva")}
                                                </option>
                                                <option value="Beer Sheva">
                                                    {t("form101.beer_sheva")}
                                                </option>
                                                <option value="Shefram">
                                                    {t("form101.sheram")}
                                                </option>
                                                <option value="Rishon Lezion">
                                                    {t("form101.rishon_lezion")}
                                                </option>
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    form["bid-martial"] !=
                                                        ...
                                                        <>
                                                            <div className="form-check">
                                                                <input
                                                                    className="form-check-input bidr"
                                                                    type="radio"
                                                                    id="io_check"
                                                                    onChange={(
                                                                        e
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-4">
                                        <div className="form-group">
                                            ...
                                            {form.length != 0 &&
                                            form["p-settlement"] != null ? (
                                                <input
                                                    type="text"
                                                    className="form-control"
                                                    value={form["p-settlement"]}
                                                    readOnly
                                                />
                                            ) : (
                                                <select
                                        ...
                                        <div className="form-group">
                                            ...
                                            form["p-sex"] != null ? (
                                                ...
                                                <>
                                                    <div className="form-check">
                                                        <input
                                                            className="form-check-input pidr"
                                                            type="radio"
                                                            onChange={(e) =>
                                                                handleSubmit(e)
                                                            }
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-2">
                                        <div className="form-group">
                                            ...
                                            <button
                                                type="button"
                                                className="btn btn-danger remove saveBtn mt-4"
                                                onClick={() =>
                                                    removeFormFields(index)
                                                }
                                            >
                                                {t("form101.button_remove")}
                                            </button>
                                            {/*
                        index && form.length == 0 ?
                                ...
                                <div className="row">
                                    <div className="col-sm-4">
                                        <div className="form-group">
                                            <input
                                                type="checkbox"
                                                value="A month salary"
                                                onChange={(e) =>
                                                    handleSubmit(e)
                                                }
                                                name="income"
                                            />{" "}
                                            {t("form101.month_salary")}
                                        </div>
                                    </div>
                                    <div className="col-sm-4">
                                        <div className="form-group">
                                            <input
                                                type="checkbox"
                                                value="Salary for an additional position"
                                                onChange={(e) =>
                                                    handleSubmit(e)
                                                }
                                                name="income"
                                    ...
                                    <div className="col-sm-4">
                                        <div className="form-group">
                                            <input
                                                type="checkbox"
                                                value="Wages (Daily worker)"
                                                onChange={(e) =>
                                                    handleSubmit(e)
                                                }
                                                name="income"
                                            />{" "}
                                            {t("form101.daily_wages")}
                                        </div>
                                    </div>
                                </div>
                            </>
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        <div className="form-group">
                                            ...
                                            form.signature != null &&
                                            form.excertion != null &&
                                            form["excertion"].excertion !=
                                                undefined &&
                                            form[
                                                "excertion"
                                            ].excertion.includes("excluded") ? (
                                                <>
                                                    <input
                                                        type="checkbox"
                                                        checked
                ...
                <div className="box-heading">
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-4 col-xs-6">
                            <div className="form-group">
                                ...
                                {form.length != 0 &&
                                form["SpouseIdentification"] != null ? (
                                    <span className="text-success font-weight-bold">
                                        {form["SpouseIdentification"] == "byId"
                                            ? "ID Proof"
                                            : "Passport"}
                                    </span>
                                ) : (
                    ...
                    <div className="col-sm-12">
                        <div
                            aria-hidden={selected !== "passport" ? true : false}
                        >
                            <div className="row">
                                <div className="col-sm-4">
                                    <div className="form-group">
                    ...
                    <div className="row">
                        <div className="col-sm-12">
                            <div className="form-group">
                                ...
                                form.signature != null &&
                                form.taxCredit != null &&
                                form["taxCredit"].taxCredit != undefined &&
                                form["taxCredit"].taxCredit.includes(
                                    "resident"
                                ) ? (
                                    <>
                                        <input
                                ...
                                form.cordination == false ? (
                                    <>
                                        <input
                                            ...
                                            id="cordination1"
                                            onClick={() =>
                                                setCordination(false)
                                            }
                                        />{" "}
                                        {t("form101.coordination_no")}
                                    </>
                                ) : (
                                    <>
                                        <input
                                ...
                                form.cordination == true ? (
                                    <>
                                        <input
                                            ...
                                            checked
                                            id="cordination2"
                                            onClick={() => setCordination(true)}
                                        />{" "}
                                        {t("form101.coordination_yes")}
                                    </>
                                ) : (
                                    <>
                                        <input
                        ...
                        <>
                            ...
                            <div>
                                ...
                                form.cord == "1" ? (
                                    <>
                                        ...
                                        />{" "}
                                        {t(
                                            "form101.additional_income_beginning"
                                        )}
                                    </>
                                ) : (
                                    <>
                            ...
                            {cord && cord == "0" && (
                                <div className="borderBox mt-3">
                                    <label className="control-label d-block">
                                        {t("form101.label_income_proof")}
                                    </label>
                                    {form &&
                                    form.signature != null &&
                                    form.cord0_file != null ? (
                                        <>
                                            <button
                                                type="button"
                                                className="btn btn-pink m-2"
                            ...
                            {cord && cord == "1" && (
                                <div className="borderBox mt-3">
                                    <label className="control-label">
                                        {t("form101.additional_income_details")}
                                    </label>
                            ...
                            {cord && cord == "2" && (
                                <div className="borderBox mt-3">
                                    <label className="control-label d-block">
                                        {t("form101.taxCordination")}
                                    </label>
                                    {form &&
                                    form.signature != null &&
                                    form.cord2_file != null ? (
                                        <>
                                            <button
                                                type="button"
                                                className="btn btn-pink m-2"
