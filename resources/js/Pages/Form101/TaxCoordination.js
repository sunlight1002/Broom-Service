    ...
    return (
        <div>
            ...
            <CheckBox
                ...
                checked={values.TaxCoordination.hasTaxCoordination}
            ...
            {values.TaxCoordination.requestReason === "reason1" && (
                <div>
                    ...
                    {touched.TaxCoordination &&
                        errors.TaxCoordination &&
                        touched.TaxCoordination.requestReason1Certificate &&
                        errors.TaxCoordination.requestReason1Certificate && (
            ...
            {values.TaxCoordination.requestReason === "reason3" && (
                <div>
                    <label htmlFor="TaxCoordination.requestReason3Certificate">
                        Tax coordination certificate from the assessing officer
                    </label>
                    <br />
                    <input
                        type="file"
                    ...
                    {touched.TaxCoordination &&
                        errors.TaxCoordination &&
                        touched.TaxCoordination.requestReason3Certificate &&
                        errors.TaxCoordination.requestReason3Certificate && (
                            <p className="text-danger">
                                {
                                    errors.TaxCoordination
            ...
            {values.TaxCoordination.requestReason === "reason2" && (
                <div>
                    {values.TaxCoordination.employer.map((child, index) => (
                        <div key={index}>
                            <hr />
                            Employer/Payer of salary {index + 1}{" "}
                            <button
                                type="button"
                            ...
                            <div className="row">
                                <div className="col-4">
                                    <TextField
                                        ...
                                        onBlur={handleBlur}
                                        error={
                                            touched.TaxCoordination.employer &&
                                            touched.TaxCoordination.employer[
                                                index
                                            ] &&
                                            touched.TaxCoordination.employer[
                                            ...
                                            errors.TaxCoordination.employer &&
                                            errors.TaxCoordination.employer[
                                                index
                                            ] &&
                                            errors.TaxCoordination.employer[
                                ...
                                <div className="col-4">
                                    ...
                                    {touched.TaxCoordination.employer &&
                                        ...
                                        touched.TaxCoordination.employer[index]
                                            .payslip &&
                                        errors.TaxCoordination.employer &&
                                        errors.TaxCoordination.employer[
                                            index
