...
<body style="font-family: 'Open Sans', sans-serif; color: #212529; background: #fcfcfc;">
    <div style="max-width: 650px; margin: 0 auto; margin-top: 30px; margin-bottom: 20px; background: #fff; border: 1px solid #e6e8eb; border-radius: 6px; padding: 20px;">
        ...
        <h1 style="text-align: center;">{{ __('mail.unanswered_lead.header') }}</h1>
        <p style="text-align: center;">{{ __('mail.unanswered_lead.greeting', ['name' => $client['firstname']]) }}</p>
        <p style="text-align: center;">{{ __('mail.unanswered_lead.content') }}</p>
        <p style="text-align: center;">
            {{ __('mail.unanswered_lead.assistance') }} <span style="color:#0130c6; font-weight:700;">03-525-70-60</span>.
        </p>
        <p style="text-align: center;">
