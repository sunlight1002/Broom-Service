...
<head>
    ...
    <title>Regarding Your Inquiry | Broom Service</title>
</head>
<body style="font-family: 'Open Sans', sans-serif; color: #212529; background: #fcfcfc;">
    <div style="max-width: 650px; margin: 0 auto; margin-top: 30px; margin-bottom: 20px; background: #fff; border: 1px solid #e6e8eb; border-radius: 6px; padding: 20px;">
        ...
        <h1 style="text-align: center;">{{ __('mail.irrelevant_lead.header') }}</h1>
        <p style="text-align: center;">
            {{ __('mail.irrelevant_lead.greeting', ['name' => $client['firstname']]) }}
        </p>
        <p style="text-align: center;">
            {{ __('mail.irrelevant_lead.content') }}
        </p>
        <p style="text-align: center;">
            {{ __('mail.irrelevant_lead.service_areas') }}
        </p>
        <ul style="list-style-type: none; padding: 0; text-align: left;">
            ...
            <li>Kiryat Ono</li>
            <li>Ganei Tikva</li>
            <li>Ramat HaSharon</li>
            <li>Kfar Shmaryahu</li>
            <li>Rishpon</li>
            <li>Herzliya</li>
        </ul>
        <p style="text-align: center;">
            {{ __('mail.irrelevant_lead.future_contact') }}
        </p>
