...
final class ClientMetaEnum extends AbstractEnum
{
    ...
    public const NOTIFICATION_SENT_UNANSWERED_1DAY = 'notification_sent_unanswered_1day';
    public const NOTIFICATION_SENT_UNANSWERED_3DAYS = 'notification_sent_unanswered_3days';
    public const NOTIFICATION_SENT_UNANSWERED_4DAYS = 'notification_sent_unanswered_4days';
