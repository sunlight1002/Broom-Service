...
class WorkerLeadWebhookController extends Controller
{
    ...
    protected $botMessages = [
        ...
        'step2' => [
            'en' => "Do you have a valid work visa or ID as mentioned above?\n**Yes / No**",
