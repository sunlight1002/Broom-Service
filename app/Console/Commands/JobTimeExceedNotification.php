...
class JobTimeExceedNotification extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'notification:job-time-exceed';
     ...
     * @var string
     */
    protected $description = 'Job notification, if job time exceeded';
    ...
    public function handle()
    {
        ...
        $jobs = Job::query()
            ...
            ->whereRaw('jobs.actual_time_taken_minutes - job_services.duration_minutes > 0')
            ->get();
        ...
        foreach ($jobs as $key => $job) {
            ...
            $emailData = [
                ...
                'emailContent'  => __('mail.job_common.worker_exceed_job_time'),
            ];
            ...
            Notification::create([
                ...
                'type' => NotificationTypeEnum::WORKER_EXCEED_JOB_TIME,
                'status' => 'job-time-exceed',
                'job_id' => $jobArray['id']
            ]);

            // notify admin
            event(new WhatsappNotificationEvent([
                "type" => WhatsappMessageTemplateEnum::WORKER_EXCEED_JOB_TIME,
                "notificationData" => array(
                    'job' => $jobArray,
                    'content' => 'Worker has exceeded the job time.'
                )
            ]));
        }
