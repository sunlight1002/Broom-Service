...
class JobNotStartedReminder extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'reminder:job-not-started';
     ...
     * @var string
     */
    protected $description = 'Job reminder, if not started';
    ...
    public function handle()
    {
        ...
        foreach ($jobs as $key => $job) {
            ...
            Notification::create([
                ...
                'type' => NotificationTypeEnum::WORKER_NOT_STARTED_JOB,
                'status' => 'not-started',
                'job_id' => $jobArray['id']
            ]);
            ...
            event(new WhatsappNotificationEvent([
                "type" => WhatsappMessageTemplateEnum::WORKER_NOT_STARTED_JOB,
                "notificationData" => array(
                    'job' => $jobArray,
                    'content' => 'Worker has not started the job yet.'
                )
            ]));
        }
